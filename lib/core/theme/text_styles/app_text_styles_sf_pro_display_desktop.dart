...
class AppTextStylesSfProDisplayDesktop implements AppTextStyles {
  ...
  @override
  TextStyle get body2 => base.copyWith(fontWeight: FontWeight.w400);

  @override
  TextStyle get body3 => base.copyWith(fontSize: 12);
  ...
  @override
  TextStyle get subtitle1 => base.copyWith(fontSize: 20).withLineHeight(48);
